            ...
            ? (function (t, e, i) {
                 return function n(s) {
                    ...
                    for (let { target: r } = s; r && r !== this; r = r.parentNode)
                       for (const a of o) if (a === r) return N(s, { delegateTarget: r }), n.oneOff && I.off(t, s.type, e, i), i.apply(r, [s]);
                 };
              })(t, i, r)
            : (function (t, e) {
                 return function i(n) {
   ...
   class xn extends W {
      constructor(t) {
         super(t),
            ...
            this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), I.on(this._element, "keydown.bs.tab", (t) => this._keydown(t)));
      }
      static get NAME() {
         return "tab";
      }
